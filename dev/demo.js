...
var datGuiSetup = function (_dat$GUI) {
    _inherits(datGuiSetup, _dat$GUI);

    function datGuiSetup(plugin) {
        _classCallCheck(this, datGuiSetup);

        var _this = _possibleConstructorReturn(this, (datGuiSetup.__proto__ || Object.getPrototypeOf(datGuiSetup)).call(this));
    ...
    _createClass(datGuiSetup, [{
        key: 'makeFolders',
        value: function makeFolders() {
            var _this2 = this;

            /// GLOBAL
            var folder = this.addFolder('Global');
            var f = folder.add(this.settings, 'active');
            f.onChange(function (value) {
                if (value) {
                    _this2.plugin.resume();
                } else {
                    _this2.plugin.pause();
                }
            });
            ...
            f.onChange(function (value) {
                _this2.plugin.setRate(value);
            });
            f = folder.add(this.settings, 'waterRate', 0, 5);
            f.onChange(function (value) {
                _this2.plugin.setRate(value, 1384);
            });
            f = folder.add(this.settings, 'lavaRate', 0, 5);
            f.onChange(function (value) {
                _this2.plugin.setRate(value, 1412);
            });
            ...
            var rightMap = this.addFolder('Right map');
            f = rightMap.add(this.settings.rightMap, 'active');
            f.onChange(function (value) {
                if (value) {
                    _this2.plugin.resume(null, 1);
                } else {
                    _this2.plugin.pause(null, 1);
                }
            });

            f = rightMap.add(this.settings.rightMap, 'waterRate', 0, 5);
            f.onChange(function (value) {
                _this2.plugin.setRate(value, 1384, 1);
            });
            rightMap.open();
        }
    }, {
        key: 'fixGuiValues',
        value: function fixGuiValues() {
...
var _datGuiSetup = __webpack_require__(/*! ./dat.gui.setup.js */ "./src/demo/dat.gui.setup.js");

var _datGuiSetup2 = _interopRequireDefault(_datGuiSetup);
...
var Demo = function (_Phaser$Scene) {
    ...
    _createClass(Demo, [{
        ...
        value: function create() {
            ...
            var tileset2 = map.addTilesetImage('super-mario-16bit', 'super-mario-16bit');
            // Add first maps three layers with corresponing tilesets (the third having a tileset of it's own)
            var layer1 = map.createDynamicLayer('ground', tileset, 0, 0);
            var layer2 = map.createDynamicLayer('aboveGround', tileset, 0, 0);
            var layer3 = map.createDynamicLayer('another', tileset2, 0, 0);
            ...
            var map2layer = map2.createDynamicLayer('ground', tileset, 160, 0);
            this.animatedTiles.init(map2);

            // start dat.gui
            new _datGuiSetup2.default(this.animatedTiles);
...
var _demo = __webpack_require__(/*! ./demo.js */ "./src/demo/demo.js");
...
/***/ 0:
/*!***********************************************!*\
  !*** multi babel-polyfill ./src/demo/main.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! /home/niklas/projekt/temp/phaser-animated-tiles/src/demo/main.js */"./src/demo/main.js");
